...
import { CHANGE_FIELD, changeField, SAVE_USER, saveUser, LOGOUT, logout,
...
describe.only('Reducer user', () => {
  describe('Structure', () => {
    ...
    it('should return the initialState when called without argument', () => {
      ...
      // dans l'exemple on récupère, l'initialState qu'on a importé depuis notre reducer, donc la référence est exactement la même => OK pour le test
